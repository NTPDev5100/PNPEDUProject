...
public class UpdateGradeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtUpdateScoreCode=findViewById(R.id.EditTextUpdateScoreCode);
        edtUpdateScore1=findViewById(R.id.EditTextUpdateScore1);
        edtUpdateScore2 = findViewById(R.id.EditTextUpdateScore2);
        edtUpdateScore3=findViewById(R.id.EditTextUpdateScore3);
        edtUpdateFinal = findViewById(R.id.EditTextUpdateFinal);
        edtUpdateTotal = findViewById(R.id.EditTextUpdateTotal);

        btnUpdateScore = findViewById(R.id.buttonUpdateGrade);
    ...
    private void DialogUpdate(int id, int id_student) {
        ...
        dialog.setContentView(R.layout.dialogupdatescore);
        dialog.setCanceledOnTouchOutside(false);

        Button btnYes = dialog.findViewById(R.id.buttonYesupdateScore);
        Button btnNo = dialog.findViewById(R.id.buttonNoupdateScore);
        ...
        btnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UpdateGradeActivity.this, TeacherStudentGradeActivity.class);
                //Gui id cua student
                intent.putExtra("id_student",id_student);
                startActivity(intent);
                Toast.makeText(UpdateGradeActivity.this,"more success",Toast.LENGTH_SHORT).show();
                finish();
                dialog.dismiss();
